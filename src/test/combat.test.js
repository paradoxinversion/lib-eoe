const { createInitiative, generateInitiative, getPossibleTargets, doCombat } = require("../combat")
...
describe("combat", ()=>{
    ...
    test("doCombat", () => {
        ...
        expect(combatResult.characters.attackers).toHaveLength(attackingForce.length);
        expect(combatResult.characters.defenders).toHaveLength(defendingForce.length);
    });
})